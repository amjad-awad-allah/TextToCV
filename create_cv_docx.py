...
# Adjust margins to fit everything neatly on the page
...
def add_job(title, company, date, bullets):
    ...
    for bullet in bullets:
        ...
        bp.paragraph_format.space_after = Pt(1)   # tight spacing
...
add_job("Umschulung zum Fachinformatiker für Anwendungsentwicklung", "BFZ Essen", "2025 – heute", 
...
add_job("B.Sc. Künstliche Intelligenz", "Arab International University, Damaskus", "2012–2017",
